...
public class ConnectToUser <T> implements Runnable {
    ...
    public ConnectToUser(String IP) {
        ...
        try {
            ...
            System.out.println("Unknown host exception: " + connection_failure_reason);
        } catch (SocketException ex) {
            connected = false;
            connection_failure_reason = "Unable to open socket on port " + ReceivePort;
            System.out.println("Socket failure: " + connection_failure_reason);
        }
    }
